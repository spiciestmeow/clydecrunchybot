"""
CAY'S CRUNCHY CHECKER BOT
Channel: @caysredirect
Developer: @caydigitals
"""

import concurrent.futures   # ← Add this at the top with other imports
import time
import uuid
import requests
...
# ============= CONFIGURATION =============
BOT_TOKEN = "8760311089:AAFc1sZ5YZWlGk91zL3TxRGJ7UiVdOJznaE"
ADMIN_ID = 7399488750
...
# ============= CRUNCHYROLL CHECKER CORE =============
TIMEOUT = 30

# ============= THREADS CHECKER CORE =============
MAX_THREADS = 125
DEFAULT_THREADS = 125
...
# ============= MAIN FUNCTION =============
def main():
    print("Starting Cay's Crunchy Checker Bot...")
    print(f"Channel: {CHANNEL_USERNAME}")
    print(f"Developer: @caydigitals")
